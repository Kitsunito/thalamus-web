    ...
    return (
        <motion.main className="ejerciciosMobile"
            ...
            >
                ...
                <iframe loading="lazy" width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLx2jwbxdaQHQkMHzyqGoycsUW3THG67KW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </motion.section>
            <motion.section className="bg-2"
                variants={plansVariants}
            >
